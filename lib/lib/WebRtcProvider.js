...
exports.WebRtcProvider = ({ mediaStreamProvider, signallingChannel, sid, children, config, logging }) => {
    const managerRef = react_1.useRef();
    if (!managerRef.current) {
        managerRef.current = new WebRtcManager_1.WebRtcManager(signallingChannel, mediaStreamProvider, sid, config, logging);
    }
    react_1.useEffect(() => {
