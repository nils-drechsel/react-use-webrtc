...
exports.WebRtcProvider = ({ mediaStreamProvider, signallingChannel, sid, children }) => {
    const managerRef = react_1.useRef();
    if (!managerRef.current) {
        managerRef.current = new WebRtcManager_1.WebRtcManager(signallingChannel, mediaStreamProvider, sid);
    }
    react_1.useEffect(() => {
