...
class MediaDevicesManager {
    ...
    addRemoteMediaStream(remoteSid, objId, stream) {
        if (this.logging)
            console.log("adding media stream", objId, stream, remoteSid);
        return this.addMediaStreamObject(objId, {
            objId,
    ...
    updateStreamDimensions(objId, width, height) {
        ...
        if (this.logging)
            console.log("updating stream dimensions", objId, width, height, mediaObj);
    ...
    getCameraStream(cameraDeviceId, audioDeviceId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logging)
            ...
            return yield this.getStream(false, constraints);
        });
    }
    getScreenStream() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.assertMediaPermissions();
            return yield this.getStream(true, undefined);
        });
    }
    ...
    getStream(screenshare, constraints) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logging)
    ...
    destroy() {
        this.mediaObjects.forEach((obj, objId) => {
            if (obj.type === MediaType.STREAM) {
