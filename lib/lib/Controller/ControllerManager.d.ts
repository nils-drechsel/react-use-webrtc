...
export declare class ControllerManager {
    ...
    inboundControllers: ObservedMapMap<InboundController>;
    ...
    inboundControllerAdded(remoteSid: string, payload: AddInboundControllerPayload): void;
    inboundControllerRemoved(remoteSid: string, payload: RemoveInboundControllerPayload): void;
    inboundControllerModified(remoteSid: string, payload: ModifyInboundControllerPayload): void;
    removeInboundController(remoteSid: string, controllerId: string): void;
    removeInboundParticipant(remoteSid: string): void;
    outboundControllerModified(remoteSid: string, payload: ModifyOutboundControllerPayload): void;
    ...
    disconnectP2pIfPossible(remoteSid: string): void;
